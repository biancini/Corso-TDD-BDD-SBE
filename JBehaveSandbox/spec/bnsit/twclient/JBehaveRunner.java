...
import bnsit.twclient.console.ConnectionSteps;
import bnsit.twclient.console.ShowingTimelineSteps;
import bnsit.twclient.steps.AuthConnectionSteps;
...
public class JBehaveRunner extends JUnitStories {
	...
	public JBehaveRunner() {
		...
		embedderControls.useStoryTimeoutInSecs(10);
	...
	public InjectableStepsFactory stepsFactory() {
		return new InstanceStepsFactory(configuration(), 
				new ConnectionSteps(), new ShowingTimelineSteps());
	}
	
	@Override
	protected List<String> storyPaths() {
		return Arrays.asList(
				"bnsit/twclient/console/checking_connection.story",
				"bnsit/twclient/console/showing_timeline.story");
	}	
}
